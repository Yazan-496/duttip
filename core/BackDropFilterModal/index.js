  ...
  return (
    <>
      <div
        ...
        className={`${
          showModal
            ? "transition-all duration-[0.3s] ease-[ease-in-out] delay-[0s]  left-[-100%] top-0"
            : "transition-all duration-[0.9s] ease-[ease-in-out] delay-[0s] left-[200%] top-0"
        } absolute w-[200%] 
      ...
      >
        <div
          style={{
            ...
            height: height,
            top: top,
            left: showModal ? left : "100%",
          }}
          ref={modalRef}
          className={`${
            showModal
              ? `transition-all duration-[0.5s] ease-[ease-in-out] delay-[0s]`
        ...
        >
          <div
            className={`w-[${width1}] h-[${height}] flex flex-col flex-nowrap justify-start justify-items-start items-start content-start px-[1.5%] py-[2vh]`}
          >
            {children}
          </div>
        </div>
