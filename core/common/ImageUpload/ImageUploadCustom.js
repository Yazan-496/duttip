...
const ImageUploadCustom = ({ onChange, imageState, type }) => {
    ...
    if (file) {
      ...
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_BASE_UPLOAD_IMAGE_URL}`,
          {
            method: "POST",
            body: formData,
          },
  ...
  return (
    <div className="relative w-[18.4vh] h-[18.4vh] border-[0.1vh] border-solid shadow-[1.4px_7px_14px_3.5px_#0000000d] border-[#0189DE]  p-[0.9vh] rounded-[3vh] bg-[#0189DE22]">
      <img
        alt="image"
        width="16.6vh"
        height="16.6vh"
      ...
      />
      <div className="absolute right-[-5%] bottom-[-1vh] cursor-pointer rounded-[3vh]">
        <svg
          ...
          style={{
            ...
            backgroundColor: "rgba(1,137,222,0.87)",
            borderRadius: "2.3vh",
          }}
        >
          <g
            id="Group 117640"
            style={{ background: "#FFFFFF", backgroundColor: "transparent" }}
          >
