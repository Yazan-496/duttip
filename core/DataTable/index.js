...
import { MRT_Localization_AR } from "core/Language/arabicTable";
  ...
  return (
    <>
      <MaterialReactTable
        ...
        localization={lang}
        layoutMode={"semantic"}
        // defaultColumn={{maxSize: 700, minSize: 10, size: 50,}}
        ...
        // enableRowActions
        enableRowActions={
          getRowActionsButtons ? getRowActionsButtons().isShowActions : false
        }
        editingMode={"modal"}
        enableRowSelection
        ...
        renderRowActionMenuItems={({ table, row, closeMenu }) => {
          return getRowActionsButtons(row, closeMenu).buttons;
        }}
            ...
            ? ({ table }) => {
                ...
                return (
                  <div style={{ display: "flex", gap: "0.5rem" }}>
                    <div className="gap-x-[2vh] w-full h-[6.5vh] relative bg-transparent rounded-[2vh] py-[1vh] flex justify-end">
                      <ButtonSave
